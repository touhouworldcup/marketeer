...
int GuiLauncherMain()
{
    ...
    while (LauncherWndNewFrame()) {
        ...
        bool canMove = false;
        bool mktIsStreaming = LauncherMktIsStreaming();
        ...
        if (mktIsStreaming) {
            ImGui::PushStyleColor(ImGuiCol_TitleBg, ImVec4(0.483f, 0.142f, 0.735f, 1.0f));
            ImGui::PushStyleColor(ImGuiCol_TitleBgActive, ImVec4(0.483f, 0.142f, 0.735f, 1.0f));
        }
